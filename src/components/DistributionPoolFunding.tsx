...
import EditStream from "@/components/distribution-pool-funding/EditStream";
import TopUp from "@/components/distribution-pool-funding/TopUp";
import Wrap from "@/components/distribution-pool-funding/Wrap";
import Review from "@/components/distribution-pool-funding/Review";
import Success from "@/components/distribution-pool-funding/Success";
import { Network } from "@/types/network";
import DistributionPoolDetails from "@/components/DistributionPoolDetails";
        ...
        <Stack direction="vertical" className="flex-grow-0">
          ...
          <Accordion activeKey={step} className="mt-4">
            ...
            <Success
              ...
              councilUiLink="https://onchain.flowstate.network"
              newFlowRate={newFlowRate}
            />
          </Accordion>
        </Stack>
